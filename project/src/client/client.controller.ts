...
export class ClientController {
  ...
  @Post(':idCli/projects/:idProj')
  async addClientToProject(@Param('idCli') idCli: number, @Param('idProj') idProj: number) {
    return await this.clientService.addClientToProject(idCli, idProj);
  }
